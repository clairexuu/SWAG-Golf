...
- Python 3.8+
- ~5GB disk space (PyTorch + embedding model weights)
...
Edit `init_style_and_embeddings.sh` to configure your style:
...
3. Builds image embeddings and caches them in `rag/cache/`
...
| `CLIP_MODEL` | No | `google/siglip-base-patch16-224` | Vision-language model for embeddings |
